...
CREATE TABLE IF NOT EXISTS rentals (rentalId uuid PRIMARY KEY, copyId uuid REFERENCES copies (copyId), userId uuid REFERENCES users (internalId), dueDate date NOT NULL, returnDate date); 
